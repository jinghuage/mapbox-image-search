(function(document, window) {
   ...
   function searchPhotos(text, page, lat, lon, radius) {

      if(text === undefined) text="";
      if(page === undefined) page = 1;
      if(lon === undefined) lon = -91.171; //-77.034084;
      if(lat === undefined) lat = 30.407;//38.909671;
      if(radius === undefined) radius = 5;


      //console.log('searchPhotos:', text, page, lat, lon, radius);
